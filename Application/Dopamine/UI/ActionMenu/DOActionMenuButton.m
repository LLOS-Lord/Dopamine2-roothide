...
+(DOActionMenuButton*)buttonWithAction:(UIAction *)action chevron:(BOOL)chevron
{
    ...
    UIButtonConfiguration *nativeConfiguration = button.configuration;
    nativeConfiguration.contentInsets = NSDirectionalEdgeInsetsMake(0, 4, 0, 4);
    button.configuration = nativeConfiguration;
