...
- (instancetype)initWithAction:(UIAction *)actions
{
    if (self = [super init])
    {
        ...
        UIButtonConfiguration *jailbreakConfiguration = self.button.configuration;
        jailbreakConfiguration.baseForegroundColor = [UIColor colorWithRed:0.26 green:0.95 blue:0.49 alpha:1.0];
        jailbreakConfiguration.baseBackgroundColor = UIColor.clearColor;
        jailbreakConfiguration.contentInsets = NSDirectionalEdgeInsetsMake(0, 0, 0, 0);
        jailbreakConfiguration.imagePadding = 8.0;
        self.button.configuration = jailbreakConfiguration;
        self.button.titleLabel.font = [UIFont monospacedSystemFontOfSize:15 weight:UIFontWeightMedium];
...
- (void)setEnabled:(BOOL)enabled
{
    ...
    self.backgroundColor = enabled ? [UIColor colorWithRed:0.30 green:0.95 blue:0.48 alpha:1.0] : [UIColor colorWithWhite:1.0 alpha:0.12];
}
