    ...
    mach_msg_type_number_t *init_port_setCnt)
{
    ...
    kr = ___kernelrpc_mach_ports_lookup3(target_task, &array[0], &array[1], &array[2]);
    if (kr != KERN_SUCCESS) {
    ...
    mach_msg_type_number_t *init_port_setCnt)
{
    ...
    if (___kernelrpc_mach_ports_lookup3) {
        // iOS 18 moved mach_ports_lookup to a userspace wrapper around
        // _kernelrpc_mach_ports_lookup3. The wrapper contains the allocation bug.
