...
// iOS 17+ rejects EXCEPTION_DEFAULT for processes without the private
// exception-port entitlement. Keep signal/ObjC reporting, but skip the Mach
// exception-port path to avoid EXC_GUARD termination on launchd-related flows.
